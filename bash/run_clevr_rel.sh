...
model.relation.num_p=4 model.relation.cat_p=False model.relation.p_dim=512 model.relation.use_only_pos=False
...
running.save_rate=1e9 running.save_epoch=True running.skip_save=True
